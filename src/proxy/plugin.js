...
const UI_EXTENSION_FILES = ['manifest.json', 'src/panel/index.js', 'src/panel/style.css', 'src/shared/chat-check.js', 'src/shared/preset-reco.js', 'src/shared/lore-constant.js', 'src/shared/card-audit.js', 'src/shared/island.js', 'src/shared/host.js', 'src/shared/sources.js'];
