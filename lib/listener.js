...
import { countInFlight, handleControlAction, handleControlLog, handleControlStatus } from './control.js';
...
export function startStandaloneListener({ port, host }) {
    ...
    app.options(['/v1/control/status', '/v1/control/log', '/v1/control/action'], allowCors, (_req, res) => res.sendStatus(204));
